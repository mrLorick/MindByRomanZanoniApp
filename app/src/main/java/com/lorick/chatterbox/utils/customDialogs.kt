package com.lorick.chatterbox.utils
...
import com.lorick.chatterbox.databinding.ComingSoonDialogBinding
import com.lorick.chatterbox.databinding.MediaImagePickerBottomSheetBinding
import com.lorick.chatterbox.databinding.MessageDialogBinding
import com.lorick.chatterbox.databinding.SaveJournalDataDialogBinding
...
fun showDatePickerDate(context: Context, onDateSelected: (String,String,String) -> Unit,cancelCallBack:(Boolean)->Unit) {
    val calendar = Calendar.getInstance()
    val year = calendar.get(Calendar.YEAR)
    val month = calendar.get(Calendar.MONTH)
    val day = calendar.get(Calendar.DAY_OF_MONTH)
    ...
    val datePickerDialog = DatePickerDialog(
        ...
        { _, year, monthOfYear, dayOfMonth ->
            ...
            // Call the callback function with the selected date
            onDateSelected(years.format(selectedDate.time),years.format(selectedDate.time),years.format(selectedDate.time))
        },
        year,
        month,
        day
